        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="radio" id="none" name="ammount" value="none">
                    ...
                    <input type="radio" id="none name=" ammount" value="50$">
                    <label for="50$">50$</label>
                    <input type="radio" id="none name=" ammount" value="75$">
                    <label for="75$">75$</label>
                    <input type="radio" id="none" name="ammount" value="100$">
                    <label for="100$">100$</label>
                    <input type="radio" id="none" name="ammount" value="250$">
