        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="radio" id="none" name="ammount" value="none">
                    ...
                    <input type="radio" id="50$" name="ammount" value="50$">
                    <label for="50$">50$</label>
                    <input type="radio" id="75$" name="ammount" value="75$">
                    <label for="75$">75$</label>
                    <input type="radio" id="100$" name="ammount" value="100$">
                    <label for="100$">100$</label>
                    <input type="radio" id="250$" name="ammount" value="250$">
                    <label for="250$">250$</label>
                    <input type="radio" id="other" name="ammount" value="other">
            ...
            <tr>
                ...
                <td><label for="other ammount"><b>Other Ammount $</b></label>
                    <input type="text" id="other ammount" name="otherAmmount"><br></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><label for="c.card">Monthly Credit Card $</label>
                    <input type="text" class="sbar" id="c.card" name="card1">
                    <label for="c.card">For</label>
                    <input type="text" class="sbar" id="c.card" name="card2">
